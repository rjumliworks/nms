                                            ...
                                            <BCol md>
                                                <div class="ms-2">
                                                    ...
                                                    <div class="hstack gap-3 flex-wrap">
                                                        ...
                                                        <div><span class="text-muted">Designation :</span> <span class="fw-medium">{{user.designation.name}}</span></div>
                                                        <div class="vr" style="width: 1px;"></div>
                                                        <div><span class="text-muted">Affiliation :</span> <span class="fw-medium">{{user.affiliation.name}}</span></div>
                                                    </div>
                                                </div>
                                            </BCol>
                                        </BRow>
