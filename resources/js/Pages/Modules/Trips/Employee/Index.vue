<template>
    ...
    <PageHeader title="Employees" pageTitle="Executive Modules" />
    <BRow>
        <div class="col-md-12">
                ...
                <div class="card-header bg-light-subtle">
                    <div class="d-flex mb-n3">
                        ...
                        <div class="flex-grow-1">
                            ...
                            <p class="text-muted text-truncate-two-lines fs-12">Crew and staff eligible for cash advances</p>
                        </div>
                    </div>
                </div>
                        ...
                        <b-col lg>
                            <div class="input-group mb-1">
                                ...
                                <b-button type="button" variant="primary" @click="openCreate">
                                    <i class="ri-add-circle-fill align-bottom me-1"></i> New Employee
                                </b-button>
                            </div>
                        </b-col>
                    </b-row>
