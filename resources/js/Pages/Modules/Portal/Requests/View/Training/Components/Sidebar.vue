        ...
        <div class="card-header bg-light-subtle">
            <div class="d-flex mb-n3">
                ...
                <div class="flex-grow-1">
                    <h5 class="mb-0 fs-14"><span class="text-body">Approval of Training</span></h5>
            ...
            <div class="row g-3 p-3">
                ...
                <div class="col-md-6">
                    <div class="d-flex border border-dashed rounded p-3">
                        ...
                        <div class="flex-grow-1 overflow-hidden">
                            <p class="mb-0 text-muted fs-12">Requested By :</p>
                ...
                <div class="align-items-center d-flex">
                    <p class="ms-3 mb-0 text-primary fs-12 fw-semibold flex-grow-1">Name of Participants</p>
